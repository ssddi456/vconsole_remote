...
function createSelectorFromEvent(el, childSelector) {
    ...
    if (el.parentNode) {
        var idx = [].slice.call(el.parentNode.children).indexOf(el) + 1;
        return createSelectorFromEvent(el.parentNode, nodeName + ':nth-child(' + idx + ')' + childSelector);
    } else {
